...
public class LinkagePrimaryAdapter extends RecyclerView.Adapter<LinkagePrimaryViewHolder> {
    ...
    private int mClickSelectedPosition = -1;
    ...
    public void setSelectedPosition(int selectedPosition) {
        ...
        //当有选中的position时，展示选中的position
        if (mClickSelectedPosition > 0 && mClickSelectedPosition != mSelectedPosition) {
            mSelectedPosition = mClickSelectedPosition;
            mClickSelectedPosition = -1;
        }else{
            mClickSelectedPosition = -1;
        }

        mConfig.onItemSelectedChange(selectedPosition);
        notifyDataSetChanged();
    }

    public int getClickSelectedPosition() {
        return mClickSelectedPosition;
    }

    public void setClickSelectedPosition(int ClickSelectedPosition) {
