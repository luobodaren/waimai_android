...
public class ExecutorServiceUtil {
    ...
    private volatile static ExecutorServiceUtil appExecutors;

    public static ExecutorServiceUtil getInstance() {
        if (appExecutors == null) {
            synchronized (ExecutorServiceUtil.class) {
                if (appExecutors == null) {
                    appExecutors = new ExecutorServiceUtil();
                }
            }
        }
        return appExecutors;
    ...
    public ExecutorServiceUtil(ExecutorService diskIO, ExecutorService networkIO, Executor mainThread, ScheduledExecutorService scheduledExecutor) {
        this.diskIO = diskIO;
