...
public class LinkageGroupedItemShopGoods extends BaseGroupedItem<LinkageGroupedItemShopGoods.ItemInfo> {


    public LinkageGroupedItemShopGoods(boolean isHeader, String header) {
        super(isHeader, header);
    }

    public LinkageGroupedItemShopGoods(ItemInfo info) {
        super(info);
    }
