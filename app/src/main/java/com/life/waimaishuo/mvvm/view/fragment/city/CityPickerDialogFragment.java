...
public class CityPickerDialogFragment extends DialogFragment implements TextWatcher,
    ...
    public void onStart() {
        ...
        if (window != null) {
            StatusBarUtils.setStatusBarLightMode(getActivity());    //修改状态栏亮模式
            window.setFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS,WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS); //全屏显示
