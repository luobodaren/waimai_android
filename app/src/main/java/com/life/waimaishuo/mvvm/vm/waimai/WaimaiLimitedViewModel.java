...
public class WaimaiLimitedViewModel extends BaseViewModel {
    ...
    public List getLimitedGoodsList() {
        ...
        limitedFoods.add(new LimitedFoods(goods,"50","150","500",LimitedTimeStateEnum.NO_START, "长安老牌牛肉店"));
        limitedFoods.add(new LimitedFoods(goods,"50","150","500",LimitedTimeStateEnum.STARTING, "长安老牌牛肉店"));
        limitedFoods.add(new LimitedFoods(goods,"50","150","500",LimitedTimeStateEnum.SALE_OUT, "长安老牌牛肉店"));
        limitedFoods.add(new LimitedFoods(goods,"50","150","500",LimitedTimeStateEnum.STARTING, "长安老牌牛肉店"));
        limitedFoods.add(new LimitedFoods(goods,"50","150","500",LimitedTimeStateEnum.SALE_OUT, "长安老牌牛肉店"));
        limitedFoods.add(new LimitedFoods(goods,"50","150","500",LimitedTimeStateEnum.STARTING, "长安老牌牛肉店"));
        return limitedFoods;
